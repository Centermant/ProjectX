...
namespace ProjectX
{
    public partial class VisualSettingsPanel : Panel
    {
        ...
        private void InitializeComponents()
        {
            ...
            _changeFontButton.AutoSize = true;
            ...
            _changeBackColorButton.AutoSize = true;
            ...
            _changePanelColorButton.AutoSize = true;
            ...
            // Устанавливаем положение кнопок с учетом их размера
            _changeFontButton.Location = new Point(this.Width / 2 - _changeFontButton.Width / 2, this.Height / 2 - 75);
            _changeBackColorButton.Location = new Point(this.Width / 2 - _changeBackColorButton.Width / 2, this.Height / 2 - 25);
            _changePanelColorButton.Location = new Point(this.Width / 2 - _changePanelColorButton.Width / 2, this.Height / 2 + 25);
            _saveSettingsButton.Location = new Point(this.Width / 2 - _saveSettingsButton.Width / 2, this.Height / 2 + 75);
        }
        ...
        protected override void OnResize(EventArgs eventargs)
        {
            ...
            // Обновляем положение кнопок при изменении размера панели, чтобы оставались по центру
            _changeFontButton.Location = new Point(this.Width / 2 - _changeFontButton.Width / 2, this.Height / 2 - 75);
            _changeBackColorButton.Location = new Point(this.Width / 2 - _changeBackColorButton.Width / 2, this.Height / 2 - 25);
            _changePanelColorButton.Location = new Point(this.Width / 2 - _changePanelColorButton.Width / 2, this.Height / 2 + 25);
            _saveSettingsButton.Location = new Point(this.Width / 2 - _saveSettingsButton.Width / 2, this.Height / 2 + 75);
